...
@section('content')
    ...
    <section class="banner-section" style="background-image: url(assets/images/banner/bg.jpeg);">
        <div class="container">
            <div class="">
                <div class="banner-content text-center" style="font-weight: bold !important;">
                    <h4 class="fw-normal theme-color mb-4" style="font-weight: bold !important;">NEXT MATCH</h4>
                    <p>Time : {{ \Carbon\Carbon::parse($recentMatch->match_date)->format('d F Y') }} -
                        {{ \Carbon\Carbon::parse($recentMatch->match_time)->format('g:i A') }}</p>
                    <p>Mode : LAST MAN STANDING</p>
                    <p>Code : 7238752</p>
                </div>
                <div
                    ...
                    <div class="banner-thumb-img ml-xl-50-none">
                        <a href="team-single"><img src="assets/images/banner/{{ $recentMatch->team1_id }}.png"
                                alt="banner-thumb"></a>
                    </div>
                    ...
                    <div class="banner-thumb-img mr-xl-50-none">
                        <a href="team-single"><img src="assets/images/banner/{{ $recentMatch->team2_id }}.png"
                                alt="banner-thumb"></a>
                    </div>
                </div>
            </div>
